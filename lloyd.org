...
#+begin_src emacs-lisp
  (defconst lloyds-installed-packages
    '(
      ...
      pep8
      ;; (sr-speedbar projectile flx flx-ido codesearch projectile-codesearch)
      ;; standard list:
      ...
      ;; font-utils
      flycheck ;; big improvement over flymake, apparently
...
#+begin_src emacs-lisp
  ...
  (defun set-up-elpy ()
    ...
    ;; and this doesn't work any more (elpy-default-minor-modes gone?)
    ;;better to turn off flymake in elpy, then enable flycheck after?
...
#+begin_src emacs-lisp
  ...
  ;;left side seems more intuitive to me
  (require 'sr-speedbar)
  (setq sr-speedbar-right-side nil)
  ;; turn off automatic auto-fill
