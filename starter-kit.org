...
** Starter kit basics
- Preamble: comments
  #+name: starter-kit-code-preamble
  #+header: :padline no
  #+begin_src emacs-lisp
    ;;; starter-kit.el --- Basic emacs setup -*- lexical-binding: t; encoding: utf-8-unix;  -*-
    ;;
    ;; Part of the Emacs Starter Kit
    ;;
    ;;; Commentary:
    ;; This is automatically generated from the file =starter-kit.org=,
    ;;see there for additional commentary in a literate-programming style.
    ;;
    ;;; Code:
...
*** Standard code postscript
This is not really necessary, but I like to be consistent.
#+begin_src emacs-lisp
  (provide 'starter-kit)
